...
def call(String application, String configuration) {
    ...
    timestamps {
        ...
        GrafanaContext configurationContext
        node('master') {
            ...
            configurationContext = new GrafanaContext(application, readFile(configuration), env.WORKSPACE)
            ...
            grafanaWorkflow(configurationContext, 'master')
